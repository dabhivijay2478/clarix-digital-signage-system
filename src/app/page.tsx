      ...
      <div className="grid gap-5 xl:grid-cols-[1.35fr_1fr]">
        <Card className="overflow-hidden">
          ...
          <CardContent className="grid gap-3 sm:grid-cols-2">
            ...
            <Button className="group h-14 justify-start px-4" variant="outline" onClick={() => router.push('/live-data')}><span className="flex size-8 items-center justify-center rounded-lg bg-muted text-foreground/80 transition-colors group-hover:bg-accent-foreground/15 group-hover:text-accent-foreground"><Network className="size-4" /></span>Add live data</Button>
            <Button className="group h-14 justify-start px-4" variant="outline" onClick={() => router.push('/playlists')}><span className="flex size-8 items-center justify-center rounded-lg bg-muted text-foreground/80 transition-colors group-hover:bg-accent-foreground/15 group-hover:text-accent-foreground"><Rows3 className="size-4" /></span>Create playlist</Button>
