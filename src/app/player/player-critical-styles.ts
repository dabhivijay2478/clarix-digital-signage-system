...
.mg-player-branding{position:fixed;right:20px;bottom:20px;z-index:9999;pointer-events:none;background:transparent!important;border:0!important;border-radius:0!important;padding:0!important;box-shadow:none!important;backdrop-filter:none!important;display:flex;align-items:center;justify-content:center}.mg-player-branding img{display:block;height:80px;width:auto;object-fit:contain;filter:none!important}
.mg-player-audio-unlock{position:fixed;left:24px;bottom:24px;z-index:10000;display:flex;align-items:center;gap:10px;min-height:52px;padding:0 18px;border:1px solid rgba(255,255,255,.35);border-radius:6px;background:rgba(0,0,0,.82);color:#fff;font:600 17px/1 sans-serif;cursor:pointer;box-shadow:0 8px 24px rgba(0,0,0,.28)}.mg-player-audio-unlock svg{width:22px;height:22px}.mg-player-audio-unlock:focus,.mg-player-audio-unlock:hover{outline:2px solid #fff;outline-offset:2px;background:#111827}
`;
