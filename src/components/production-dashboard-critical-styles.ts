...
.mg-prod-player-layout [data-slot="table"]{width:100%;border-collapse:collapse;table-layout:fixed;font-size:clamp(18px,2.45vh,42px);line-height:1.25}
.mg-prod-player-layout [data-slot="table-header"] [data-slot="table-row"]{border-bottom:0;background:#f8fafc}
.mg-prod-player-layout .mg-prod-th{height:auto;padding:1.15vh 0.55vw;text-align:center;vertical-align:middle;font-size:clamp(15px,1.9vh,30px);font-weight:800;letter-spacing:0;text-transform:uppercase;color:#000000;white-space:nowrap;line-height:1.1}
.mg-prod-player-layout [data-slot="table-body"] [data-slot="table-row"]{border-bottom:0}
.mg-prod-player-layout .mg-prod-td{padding:1.1vh 0.55vw;text-align:center;vertical-align:middle;white-space:nowrap;font-size:clamp(18px,2.45vh,42px);font-weight:600;color:#000000;line-height:1.22}
...
.mg-prod-player-layout .mg-prod-chart{aspect-ratio:auto!important;-webkit-box-flex:1;-webkit-flex:1 1 0;flex:1 1 0;width:100%!important;height:100%!important;min-height:0!important;max-height:none!important;font-size:clamp(14px,1.6vh,24px);color:#000000;position:relative}
...
.mg-prod-player-layout .recharts-legend-wrapper{font-size:clamp(14px,1.6vh,24px);font-weight:700;color:#000000;padding-top:0.35vh}
.mg-prod-player-layout .recharts-legend-item-text{color:#000000!important;font-size:clamp(14px,1.6vh,24px);font-weight:700}
