...
.mg-truck-stats{display:-webkit-box;display:-webkit-flex;display:flex;gap:0;-webkit-flex-wrap:wrap;flex-wrap:wrap;min-width:0;-webkit-box-flex:0;-webkit-flex:0 1 auto;flex:0 1 auto;overflow:visible;-webkit-box-align:center;-webkit-align-items:center;align-items:center;margin:0;padding:0}
.mg-truck-stat-divider{width:3px;height:clamp(52px,5.5vw,76px);background:#d1d5db;-webkit-flex-shrink:0;flex-shrink:0;-webkit-align-self:center;align-self:center;margin:0 clamp(10px,1.4vw,24px)}
.mg-truck-clock-divider{width:3px;height:clamp(52px,5.5vw,76px);background:#d1d5db;-webkit-flex-shrink:0;flex-shrink:0;-webkit-align-self:center;align-self:center;margin:0 clamp(10px,1.4vw,24px)}
.mg-truck-stat{-webkit-box-flex:0;-webkit-flex:0 0 auto;flex:0 0 auto;display:-webkit-box;display:-webkit-flex;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-webkit-flex-direction:column;flex-direction:column;-webkit-box-align:start;-webkit-align-items:flex-start;align-items:flex-start;border:none;background:transparent;overflow:visible;margin:0;padding:0}
